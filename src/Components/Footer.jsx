...
const Footer = () => {
  ...
  return (
    <div className=' flex justify-between w-full h-[115vh] bg-zinx-900'>
        <div className='w-1/2 h-screen flex-col justify-between px-20 py-40'>
            <div className='text-[9vw]/[8vw] uppercase font-["Founders_Grotesk_X-Condensed"] font-bold'>
                <h1>eye-</h1>
                <h1>opening</h1>
            </div>
            <svg className='mt-[20vw]' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='w-1/2 py-40'>
            <h1 className='text-[9vw]/[8vw] uppercase font-["Founders_Grotesk_X-Condensed"] font-bold'>presentations</h1>

            <div className='S font-["Neue_Montreal"] text-xl pt-4' >
                <h1 className='py-5'>S:</h1>
                {["Instagram","Behance","Facebook","LinkedIn"].map(item => <ul><li className='py-[4px]'>{item}</li></ul>)}
            </div>
            
            <div className='LM flex justify-between'>
            
                <div className='L font-["Neue_Montreal"] text-xl pt-4'>
                    <h1 className='py-5'>L:</h1>
                    {["202-1965 W 4th Ave","Vancouver, Canada","30 Chukarina St","Lviv, Ukraine"].map(item =>  <ul><li className='py-[4px]'>{item}</li></ul>)}
                </div>
            
                <div className='M font-["Neue_Montreal"] text-xl pt-4 pr-16'>
                    <h1 className='py-5'>M:</h1>
                    {["Home","Services","Our work","About us","Insights","Contact Us"].map(item =>  <ul><li className='py-[3px] underline'>{item}</li></ul>)}
                </div>
            </div>
            <div className="E flex flex-col justify-between h-[30%]">
                <div className='L font-["Neue_Montreal"] text-xl pt-4'>
                    <h1 className='py-5'>E:</h1>
                    <ul><li className='py-[4px]'>hello@ochi.design</li></ul>
                </div>
                <div>
                    <h1 className='font-["Neue_Montreal"] text-xl text-zinc-600'>© ochi design 2024. Legal Terms </h1>
                </div>
            </div>
        </div>
    </div>
